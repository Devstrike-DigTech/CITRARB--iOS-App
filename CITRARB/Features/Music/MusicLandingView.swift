...
struct MusicLandingView: View {
    ...
    @State private var newConnectsList: [Music] = []
    var body: some View {
        NavigationView{
            ZStack{
                //            Image("bgDay")
...
//                            }
                            ...
                            .sheet(item: $viewModel.selectedMusicItem){ identifiableMusicListItem in
                                MusicSheetView(musicItem: identifiableMusicListItem.musicItem)
                            }
                            .refreshable {
        ...
        .onAppear{
            ...
            .toolbar{
                ...
                .sheet(isPresented: $viewModel.showingNewItemView){
                 NewMusicView(newItemPresented: self.$viewModel.showingNewItemView)
            }
    }
...
struct MusicLandingView_Previews: PreviewProvider {
